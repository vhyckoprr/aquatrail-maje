...
new = function ( params )
   ...
   --Fonction définissant le comportement des sliders
	...
	local supprBtn = display.newText("Supprimez les données", 0, 0, "Fontastique", 18)
