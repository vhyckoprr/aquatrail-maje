...
new = function ( params )
	...
	--Background
	local back = display.newImage(PathMenuFolder.."fond_mondes.png")
   back.isVisible = true
   ...
   --return
	local reBtn = display.newImage(PathMenuFolder.."bouton_retour_mondes.png")
   ...
   localGroup:insert(reBtn)
	...
	--textWorlds
	local textWorlds = display.newImage(PathMenuFolder.."texte_mondes.png")
   ...
   --glaBtn (MONDE 1)
	local glaBtn = display.newImage(PathMenuFolder.."bouton_glace.png")
   ...
   --cadenas
   local glaCad = display.newImage(PathMenuFolder.."cadenas_monde_bloque.png")
   ...
   --foretBtn (MONDE 2 )
	local forBtn = display.newImage(PathMenuFolder.."bouton_foret_lock.png")
   ...
   --cadenas
   local forCad = display.newImage(PathMenuFolder.."cadenas_monde_bloque.png")
   ...
   --desertBtn (MONDE 3 )
	local desBtn = display.newImage(PathMenuFolder.."bouton_desert_lock.png")
   ...
   -- cadenas
   local desCad = display.newImage(PathMenuFolder.."cadenas_monde_bloque.png")
   ...
   --islandBtn ( MONDE 4)
	local islBtn = display.newImage(PathMenuFolder.."bouton_ile_lock.png")
   ...
   localGroup:insert(islBtn)
	-- cadenas
   local islCad = display.newImage(PathMenuFolder.."cadenas_monde_bloque.png")
