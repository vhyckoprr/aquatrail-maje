...
new = function ( params )	--Définition des path de ressource
	...
	--Background
	local back = display.newImage(PathMenuFolder.."fond_accueil.png")
   back.isVisible = true
   ...
   --logo
	local logo = display.newImage(PathMenuFolder.."logo_aquatrail.png")
   logo.isVisible = true
   ...
   localGroup:insert(logo)
	...
	--PlayButton
  	local playBtn = display.newImage(PathMenuFolder.."bouton_jouer.png")
   	...
   	--OptionsButton
  	local OptBtn = display.newImage(PathMenuFolder.."bouton_options.png")
   	...
   	--RecompensesButton
  	local RecBtn = display.newImage(PathMenuFolder.."bouton_recompenses.png")
   	...
   	--ScoreButton
  	local ScoreBtn = display.newImage(PathMenuFolder.."bouton_scores.png")
   	...
   	--CreditButton
  	local CreditBtn = display.newImage(PathMenuFolder.."bouton_credits.png")
	...
	--Exit Button
	local exitBtn = display.newImage(PathMenuFolder.."bouton_quitter.png")
