...
new = function ( params )
	...
	--Définition des path de ressource
	local PathMenuFolder = "../AssetGraph/Menu/";
	local PathMondeGlaceFolder = "../AssetGraph/MondeGlace/";
	local PathDechetFolder = "../Tiled/DechetPremierMonde/";
	...
	--Background
	local back = display.newImage(PathMenuFolder.."fond_glace.png")
   back.isVisible = true
   ...
   --return
	local reBtn = display.newImage(PathMenuFolder.."bouton_retour_glace.png")
   ...
   localGroup:insert(reBtn)
	...
	--textWorlds
	local textWorlds = display.newImage(PathMenuFolder.."texte_glace.png")
   ...
   --case1Btn
	local case1Btn = display.newImage(PathMenuFolder.."bouton_niveau_glace.png")
   ...
   --case2Btn
	local case2Btn = display.newImage(PathMenuFolder.."bouton_niveau_glace.png")
   ...
   --case3Btn
	local case3Btn = display.newImage(PathMenuFolder.."bouton_niveau_glace.png")
   ...
   --case4Btn
	local case4Btn = display.newImage(PathMenuFolder.."bouton_niveau_glace.png")
   ...
   --case5Btn
	local case5Btn = display.newImage(PathMenuFolder.."bouton_niveau_glace.png")
   ...
   --case6Btn
	local case6Btn = display.newImage(PathMenuFolder.."bouton_niveau_glace.png")
