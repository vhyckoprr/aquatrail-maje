...
local PathSoundAmbiances = "../Sound/Ambiances/";
local PathSoundBruitages = "../Sound/Bruitages/";
...
local maintheme = audio.loadSound( PathSoundAmbiances.."music_1.mp3" )
local b_stalactite = audio.loadSound( PathSoundBruitages.."b_stalactite.mp3" )
local b_saut = audio.loadSound( PathSoundBruitages.."b_saut.mp3" )
local b_gouttelette = audio.loadSound( PathSoundBruitages.."b_gouttelette.mp3" )
