...
new = function ( params )
	...
	--Background
	local back = display.newImage("fond_desert_foret.png")
   back.isVisible = true
   ...
   --case1Btn
	local case1Btn = display.newImage("bouton_niveau-foret_V2.0.png")
   ...
   --case2Btn
	local case2Btn = display.newImage("bouton_niveau-foret_V2.0.png")
   ...
   --case3Btn
	local case3Btn = display.newImage("bouton_niveau-foret_V2.0.png")
   ...
   --case4Btn
	local case4Btn = display.newImage("bouton_niveau-foret_V2.0.png")
   ...
   --case5Btn
	local case5Btn = display.newImage("bouton_niveau-foret_V2.0.png")
   ...
   --case6Btn
	local case6Btn = display.newImage("bouton_niveau-foret_V2.0.png")
